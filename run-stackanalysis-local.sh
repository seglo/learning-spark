...
$SPARK_HOME/bin/spark-submit --class "StackAnalysis" --master local[8] target/scala-2.10/learning-spark_2.10-0.1.0.jar \
  --input-file file:///home/seglo/source/learning-spark/data/stackexchange/stackoverflow.com-Posts/Posts100k.xml
